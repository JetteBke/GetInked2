...
tattoos = Tattoo.create([{ remote_photo_url: url1, description: "a butterly", user_id: users.first},
  { remote_photo_url: url2, description: "five triangles reduced in size with splatter paint", user_id: users.first},
  { remote_photo_url: url3, description: "a mircroneedled rose tattoo", user_id: users.first},
  { remote_photo_url: url4, description: "landscape tattoo", user_id: users.first},
  { remote_photo_url: url5, description: "flower on back", user_id: users.first}])
